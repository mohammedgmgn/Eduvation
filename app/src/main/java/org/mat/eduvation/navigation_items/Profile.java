...
public class Profile extends AppCompatActivity {
    ...
    Toast.makeText(Profile.this,myBase64Image,Toast.LENGTH_LONG).show();
    ...
    private void getImageFromFB_DB() {
        ...
        if (databaseConnector.isImageExist(SaveSharedPreference.getUserName(getApplicationContext()).toLowerCase())) {
            ...
            myvalueimage=new ValueEventListener() {
                @Override
            ...
            images.addValueEventListener(myvalueimage);
        }
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        if(myvalueimage!=null)
        {
            images.removeEventListener(myvalueimage);
